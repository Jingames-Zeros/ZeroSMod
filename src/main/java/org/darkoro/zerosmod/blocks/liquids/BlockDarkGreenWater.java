...
public class BlockDarkGreenWater extends BlockFluidClassic {

  @SideOnly(Side.CLIENT) private IIcon stillIcon;
  @SideOnly(Side.CLIENT) private IIcon flowIcon;

  public BlockDarkGreenWater(Fluid fluid) {
    super(fluid, Material.water);
    setBlockName("dark_green_water");
    setLightOpacity(3);
    setCreativeTab(ZeroSMod.ZeroSModTab);
  }

  @Override @SideOnly(Side.CLIENT) public void registerBlockIcons(IIconRegister register) {
    System.out.println(getClass().getResource("/assets/zerosmod/textures/blocks/liquids/dark_green_water_still.png"));
    stillIcon = register.registerIcon("zerosmod:liquids/dark_green_water_still");
    flowIcon = register.registerIcon("zerosmod:liquids/dark_green_water_flow");
