...
public class BlockYellowWater extends BlockFluidClassic {
  ...
  public BlockYellowWater(Fluid fluid) {
    super(fluid, Material.water);
    setBlockName("yellow_water");
    setLightOpacity(3);
    setCreativeTab(ZeroSMod.ZeroSModTab);
  }

  @Override @SideOnly(Side.CLIENT) public void registerBlockIcons(IIconRegister register) {
    stillIcon = register.registerIcon("zerosmod:liquids/yellow_water_still");
    flowIcon = register.registerIcon("zerosmod:liquids/yellow_water_flow");
