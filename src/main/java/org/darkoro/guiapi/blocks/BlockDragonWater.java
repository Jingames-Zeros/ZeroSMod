...
public class BlockDragonWater extends BlockFluidClassic {
    ...
    @Override @SideOnly(Side.CLIENT) public void registerBlockIcons(IIconRegister register) {
        stillIcon = register.registerIcon("genericguiapi:dragon_water_still"); // Update texture opacity please
        flowIcon = register.registerIcon("genericguiapi:dragon_water_flow"); // Update texture opacity please
